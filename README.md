...
A lot of these keys should be copied from other valid definitions. Please see the `GroundTruthCreator` helper class in [BenchBot Evaluation](https://github.com/roboticvisionorg/benchbot_eval) for assistance in creating valid ground truths.
...
| `'address'`      | Yes      | A string for the address where a running [BenchBot Robot Controller](https://github.com/roboticvisionorg/benchbot_robot_controller) can be accessed (e.g. `'localhost:10000'`)                                                                                                                                                                            |
| `'global_frame'` | Yes      | The name of the global TF frame. All poses reported by the [BenchBot API](https://github.com/roboticvisionorg/benchbot_api) will be with respect to this frame.                                                                                                                                                                                           |
| `'robot_frame'`  | Yes      | The name of the robot's TF frame.                                                                                                                                                                                                                                                                                                                         |
| `'poses'`        | Yes      | A list of named poses that this robot provides. This list of poses will be available in observations provided by the [BenchBot API](https://github.com/roboticvisionorg/benchbot_api).                                                                                                                                                                    |
...
| Key              | Required | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| ---------------- | -------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `'connection'`   | Yes      | Connection type string, used by the [BenchBot Robot Controller](https://github.com/roboticvisionorg/benchbot_robot_controller). Supported values are `'api_to_ros'` (used for actions), `'ros_to_api'` (used for observations), and `'roscache_to_api'` (special value used for caching observation values).                                                                                                                                                                                                                                                                 |
...
| `'actions'`        | Yes      | A list of named connections to be provided as actions through the [BenchBot API](https://github.com/roboticvisionorg/benchbot_api). Running this task will fail if the robot doesn't provide these named connections.       |
| `'observations'`   | Yes      | A list of named connections to be provided as observations through the [BenchBot API](https://github.com/roboticvisionorg/benchbot_api). Running this task will fail if the robot doesn't provide these named connections.  |
| `'results_format'` | Yes      | A string naming the format for results. The format must be installed, as [BenchBot API](https://github.com/roboticvisionorg/benchbot_api) will use the format's functions to provide the user with empty results.           |
